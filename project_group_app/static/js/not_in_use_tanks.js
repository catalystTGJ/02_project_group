var bullet_image = 'static/img/bullet.png'
var turret_image = 'static/img/tank_turret.png'
var chassis_image = 'static/img/tank_chassis.png'
...
function updateTank(tank_dict) {
    ...
    if (tank_dict.y > bfh - 60) {tank_dict.y = bfh - 60};
    ...
    document.getElementById(tank_dict.n + '_chassis').src = "tank_chassis.png";
    ...
    document.getElementById(tank_dict.n + '_turret').src = "tank_turret.png";
...
function drawTanks(){
    ...
    for (i=0; i<old_list.length; i++) {
        if (old_list[i].c > 0) {
            ...
            document.getElementById(old_list[i].n ).src = "bullet.png";
...
window.setInterval(drawTanks,msdelay);